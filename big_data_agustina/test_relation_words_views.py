...
from relation_words_views import reducer, words_views, chunkify, mapper
...
def test_reducer():
    """test reducer function with two lists"""
    l1 = [0, 1]
    l2 = [2, 3]
...
def test_reducer_empty_list():
    """test reducer function with an empty list"""
    l1 = [0, 1]
    l2 = []
...
def test_word_views(tree_node):
    """test word_views function"""
    r = words_views(tree_node)
